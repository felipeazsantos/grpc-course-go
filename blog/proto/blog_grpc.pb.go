...
type BlogServiceClient interface {
	...
	ListBlogs(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Blog], error)
}
...
func (c *blogServiceClient) ListBlogs(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Blog], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type BlogServiceServer interface {
	...
	ListBlogs(*empty.Empty, grpc.ServerStreamingServer[Blog]) error
...
func (UnimplementedBlogServiceServer) ListBlogs(*empty.Empty, grpc.ServerStreamingServer[Blog]) error {
...
func _BlogService_ListBlogs_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(BlogServiceServer).ListBlogs(m, &grpc.GenericServerStream[empty.Empty, Blog]{ServerStream: stream})
}
